;(function (global, factory) {
    ...
    class FastPaginator {
        ...
        getPageUrl(pageNum) {
            return Helpers.replaceArgs(this.getUrlPattern(), {
                ':num': pageNum
            });
        }
        ...
        getFirstPageLink() {
            ...
            return Helpers.replaceArgs(self.getFirstPageTmpl(), {
        ...
        getPrevPageLink() {
            ...
            return Helpers.replaceArgs(self.getPrevPageTmpl(), {
        ...
        getLastPageLink() {
            ...
            return Helpers.replaceArgs(self.getLastPageTmpl(), {
        ...
        getNextPageLink() {
            ...
            return Helpers.replaceArgs(self.getNextPageTmpl(), {
        ...
        getLinks() {
            ...
            for (let page of this.getPages()) {
                ...
                if(url) {
                    html += Helpers.replaceArgs((isCurrent ? self.getActivePageTmpl() : self.getLinksTmpl()), {
                        ':url': url,
                        ':num': num
                    });
                } else {
        ...
        toHtml() {
            ...
            if(include.template && self.getTemplate()) {
                html = Helpers.replaceArgs(self.getTemplate(), {
                    ':links': html
                });
            }
        ...
        templatePaginate() {
            ...
            return Helpers.replaceArgs(self.getTemplate(), {
        ...
        setOption(name, value) {
            if (typeof name === 'object') {
                this.options = Helpers.extend(this.defaults, name);
            } else {
